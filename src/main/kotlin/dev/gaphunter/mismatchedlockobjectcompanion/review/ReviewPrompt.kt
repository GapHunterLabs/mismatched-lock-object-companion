package dev.gaphunter.mismatchedlockobjectcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.mismatchedlockobjectcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.mismatchedlockobjectcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Mismatched Lock Object Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34075-mismatched-lock-object-companion/reviews"
